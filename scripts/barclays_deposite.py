    ...
    for tr in trs:
        ...
        if c == 0:
            ...
            if c == 1:
                ...
                MIN = p[3].text
                data.append([product_name, AER, interest, Balance, MIN, 'Term Deposits'])
                c += 1
            elif c == 2:
                interest = AER = p[1].text
                Balance = p[2].text.strip("(").strip(")\n")
...
def current():
    ...
    data.append([product_name1, None, None, None, None, None])
    data.append([product_name2, None, None, None, None, None])
...
if __name__ == '__main__':
    ...
    order = ['Date', 'Bank_Native_Country', 'State', 'Bank_Name', 'Bank_Local_Currency', 'Bank_Type', 'Bank_Product',
             'Bank_Product_Type', 'Bank_Product_Name','Min_opening_Bal','Balance', 'Bank_Offer_Feature', 'Term in Months', 'Interest_Type',
