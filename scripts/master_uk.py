...
import logging
banks = glob.glob("*.py")
Bank_Names = ['Bank_of_scotland_Deposits.py','Virgin_Bank_Deposits_New.py','bank_of_virgin_mortgage.py','BOI_Final.py',
...
'royal_bank_scotland_mortgage.py','TSB_bank_deposits.py','TSB_bank_mortgage.py','HSBC.py','HSBC_bank_mortgage.py','barclays_deposite.py','barclays_mortgage.py']
